...
class QMetaHooker():
    ...
    def cgf_update_job_status(self,v_job_id = None,v_job_status = None,v_error_info = ""):
        ...
        if (self.cgv_db_cur):
            v_sql = """update q_job_list set job_status = '%s',
                    ...
                    error_info = '%s'
                    where id = %s""" % (v_job_status,v_error_info,v_job_id);
            self.cgv_db_cur.execute(v_sql);


    def cgf_update_job_btime(self,v_job_id = None):
        """设置job的开始时间"""
        if (self.cgv_db_cur):
    ...
    def cgf_update_job_etime(self,v_job_id = None):
        """设置job的结束时间"""
        if (self.cgv_db_cur):
            v_sql = """update q_job_list set 
                    gmt_modify = CURRENT_TIMESTAMP,
...
class QTablePipe():
    ...
    def __init__(self,v_fetch_MB = 256,v_is_need_data = True,
                ...
                v_hash_type = "hash",v_line_factor = None,
...
class QWorkerBoss():
    ...
    def __init__(self,v_worker_max = 16,v_meta_hooker = None,v_sleep_seconds = 20):
        # worker数量定义
        self.cgv_worker_max = v_worker_max;
        self.cgv_meta_hooker = v_meta_hooker;
        self.cgv_sleep_seconds = v_sleep_seconds;
    ...
    def cgf_doing_myjob(self,v_job_id = None,v_job_name = "",v_run_type = "noforce"):
        ...
        # v_job_rooters_list:[[job_id,root_id,task_type],[job_id,root_id,task_type]]
        # v_task_list:[[task_id,task_name],[task_id,task_name],[task_id,task_name]]
        # root_id:vtable_id/twins_id
