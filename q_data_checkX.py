...
class QTableCat():
    ...
    def cgf_single_table_ddl(self,v_tab_name = None,v_is_truncate = False):
...
class QTablePipe():
    ...
    def __init__(self,v_pkuk_str = "",v_sharding_str = "",v_fetch_MB = 256,
                ...
                v_is_json_data = True,v_tab_owner_source = None,v_tab_name_source = None,
                v_tab_owner_target = None,v_tab_name_target = None,v_who_doing = "",
                v_source_db = None,v_crusher_db = None,v_meta_hooker = None,
                v_process_parallel = 1,v_hash_type = "hash",v_line_factor = None,
                v_task_id = 0,v_vtable_id = 0,v_sharding_id = 0,v_split_str = unichr(8364).encode("utf-8")):
        # 查询SQL信息
        self.cgv_sql = "";
        self.cgv_count_sql = "";
...
class QFatWorker(multiprocessing.Process):
    ...
    def run(self):
        if (self.cgv_what_is_fucking_goooon):
            ...
            # 每个cgv_what_is_fucking_goooon都会实现home working函数，用于进行自身的逻辑运行，任务状态更新自己处理
...
class QWorkerBoss():
    ...
    def __init__(self,v_worker_count = 16):
        # worker数量定义
        self.cgv_worker_count = v_worker_count;
    ...
    def cgf_doing_mytask(self,v_task_id = None,v_task_name = "",v_run_type = "noforce"):
