...
"""
    ...
    create sequence seq_dismiss_rows cache 10000;
    create sequence seq_surplus_rows cache 10000;
...
class QTableCat():
    ...
    def cgf_excel_reader(self,v_excel_name = "",v_excel_type = "tablelist"):
        ...
        try:
            ...
            print "QTableCat.cgf_excel_reader get error:" + str(e);
            os._exit(0);
    ...
    def cgf_virtual_tabscope(self):
        ...
        try:
            ...
            print "QTableCat.cgf_virtual_tabscope get error:" + str(e);
            os._exit(0);
    ...
    def cgf_table_meta_gen(self):
        try:
            ...
            print "QTableCat.cgf_table_meta_gen get error:" + str(e);
            os._exit(0);
    ...
    def cgf_twins_meta_gen(self):
        ...
        try:
            ...
            print "QTableCat.cgf_twins_meta_gen get error:" + str(e);
            os._exit(0);
    ...
    def cgf_hash_table_ddl(self,v_tab_name = None,v_is_truncate = False):
        ...
        try:
            ...
            print "QTableCat.cgf_hash_table_ddl get error :" + str(e);
...
class QMetaHooker():
    ...
    def cgf_get_unique_key(self):
        ...
        try:
            ...
            print "QMetaHooker.cgv_get_unique_key get error:" + str(e);
    ...
    def cgf_create_task_info(self,v_task_name = "",v_parent_id = None,v_task_type = None):
        ...
        try:
            ...
            print "QMetaHooker.cgv_create_task_info get error:" + str(e);
            self.cgv_conn_db.rollback();
            self.cgv_meta_db.cgf_disconnect_db();
            os._exit(0);
    ...
    def cgf_update_task_status(self,v_task_id = None,v_task_status = None,v_error_info = ""):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_task_status get error:" + str(e);
    ...
    def cgf_update_task_btime(self,v_task_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_task_btime get error:" + str(e);
    ...
    def cgf_update_task_etime(self,v_task_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_task_etime get error:" + str(e);
    ...
    def cgf_create_vtable_info(self,v_vtab_name = "",v_stab_name = "",v_vtab_status = "",v_source_target = ""):
        ...
        try:
            ...
            print "QMetaHooker.cgv_create_vtable_info get error:" + str(e);
            self.cgv_conn_db.rollback();
    ...
    def cgf_get_vtable_id(self,v_vtab_name = ""):
        try:
            ...
            print "QMetaHooker.cgf_get_vtable_id get error:" + str(e);
    ...
    def cgf_create_tabshard_info(self,v_vtable_id = None,v_sharding_table_name = "",
        ...
        try:
            ...
            print "QMetaHooker.cgf_create_tabshard_info get error:" + str(e);
            self.cgv_conn_db.rollback();
    ...
    def cgf_create_twins_info(self,v_svtab_name = "",v_tvtab_name = "",v_svtab_id = None,v_tvtab_id = None,v_twins_status = ""):
        ...
        try:
            ...
            print "QMetaHooker.cgv_create_twins_info get error:" + str(e);
            self.cgv_conn_db.rollback();
    ...
    def cgf_update_vtable_trows(self,v_vtable_id = None,v_table_rows = None,v_type = "add"):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_vtable_trows get error:" + str(e);
    ...
    def cgf_update_vtable_epull(self,v_vtable_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_vtable_epull get error:" + str(e);
    ...
    def cgf_update_vtable_bpull(self,v_vtable_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_vtable_bpull get error:" + str(e);
    ...
    def cgf_update_vtable_ecountoff(self,v_vtable_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_vtable_ecountoff get error:" + str(e);
    ...
    def cgf_update_vtable_bcountoff(self,v_vtable_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_vtable_bcountoff get error:" + str(e);
    ...
    def cgf_update_vtable_status(self,v_vtable_id = None,v_vtable_status = None,v_error_info = ""):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_vtable_status get error:" + str(e);
    ...
    def cgf_update_twins_bcheck(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_bcheck get error:" + str(e);
    ...
    def cgf_update_twins_echeck(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_echeck get error:" + str(e);
    ...
    def cgf_update_twins_brecheck(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_brecheck get error:" + str(e);
    ...
    def cgf_update_twins_erecheck(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_erecheck get error:" + str(e);
    ...
    def cgf_update_twins_breport(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_breport get error:" + str(e);
    ...
    def cgf_update_twins_ereport(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_ereport get error:" + str(e);
    ...
    def cgf_update_twins_brepair(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_brepair get error:" + str(e);
    ...
    def cgf_update_twins_erepair(self,v_twins_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_erepair get error:" + str(e);
    ...
    def cgf_update_twins_dismatch(self,v_twins_id = None,v_dismatch_rows = 0):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_dismatch get error:" + str(e);
    ...
    def cgf_update_twins_missing(self,v_twins_id = None,v_missing_rows = 0):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_missing get error:" + str(e);
    ...
    def cgf_update_twins_surplus(self,v_twins_id = None,v_surplus_rows = 0):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_surplus get error:" + str(e);
    ...
    def cgf_update_twins_match(self,v_twins_id = None,v_match_rows = 0):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_match get error:" + str(e);
    ...
    def cgf_update_twins_status(self,v_twins_id = None,v_twins_status = None,v_error_info = ""):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_twins_status get error:" + str(e);
        ...
        try:
            ...
            if (self.cgv_db_cur):
                ...
                if (len(v_twins_list) > 0):
                    ...
                    for i in (len(v_twins_col_desc)):
                        v_twins_info[v_twins_col_desc[i][0].lower()] = v_twins_list[0][i];

                return v_twins_info;
        except Exception as e:
            print "QMetaHooker.cgf_get_twins_info get error:" + str(e);
    ...
    def cgf_update_sharding_status(self,v_sharding_id = None,v_sharding_status = None,v_error_info = ""):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_status get error:" + str(e);
    ...
    def cgf_update_sharding_bpull(self,v_sharding_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_bpull get error:" + str(e);
    ...
    def cgf_update_sharding_epull(self,v_sharding_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_epull get error:" + str(e);
    ...
    def cgf_update_sharding_bcountoff(self,v_sharding_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_bcountoff get error:" + str(e);
    ...
    def cgf_update_sharding_ecountoff(self,v_sharding_id = None):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_ecountoff get error:" + str(e);
    ...
    def cgf_update_sharding_trows(self,v_sharding_id = None,v_sharding_rows = 0,v_type = "add"):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_trows get error:" + str(e);
    ...
    def cgf_update_sharding_pkuk(self,v_sharding_id = None,v_pkuk_str = ""):
        ...
        try:
            ...
            self.cgv_conn_db.rollback();
            print "QMetaHooker.cgf_update_sharding_keystr get error:" + str(e);
...
class QTablePipe():
    ...
    def cgf_get_key_cols(self):
        ...
        try:
            ...
            print "QTablePipe.cgf_get_key_cols get error:" + str(e);
            self.cgv_meta_hooker.cgf_update_sharding_status(v_sharding_id = self.cgv_sharding_id,
                v_sharding_status = "error",v_error_info = "QTablePipe.cgf_get_key_cols get error:" + str(e));
            self.cgv_meta_hooker.cgf_update_task_status(v_task_id = self.cgv_task_id,
                v_task_status = "error",v_error_info = "QTablePipe.cgf_get_key_cols get error:" + str(e));
            os._exit(0);
    ...
    def cgf_estimate_blockrows(self,v_set_col_desc = True,v_count_off = True):
        ...
        try:
            # 更新任务信息，任务启动，btime刷新
            self.cgv_meta_hooker.cgf_update_task_status(v_task_id = self.cgv_task_id,v_task_status = "gooooing");
            ...
            # estimate出错，子进程直接退出
            print "QTablePipe.cgf_estimate_blockrows get error:" + str(e);
            self.cgv_meta_hooker.cgf_update_sharding_status(v_sharding_id = self.cgv_sharding_id,
                v_sharding_status = "error",v_error_info = "QTablePipe.cgf_estimate_blockrows get error:" + str(e));
            self.cgv_meta_hooker.cgf_update_task_status(v_task_id = self.cgv_task_id,
                v_task_status = "error",v_error_info = "QTablePipe.cgf_estimate_blockrows get error:" + str(e));
            os._exit(0);
    ...
    def cgf_init_keycol_position(self):
        for i in xrange(len(self.cgv_key_list)):
            v_position = self.cgf_get_column_position(self.cgv_key_list[i]);
    ...
    def cgf_init_datacol_position(self):
        for i in xrange(len(self.cgv_datacol)):
            v_position = self.cgf_get_column_position(self.cgv_datacol[i]);
            if (v_position is None):
    ...
    def cgf_init_datacol_kvlist(self):
        try:
            ...
            print "QTablePipe.cgf_init_datacol_kvlist get error :" + str(e);
    ...
    def cgf_create_hashvalue_table(self):
        if (len(self.cgv_data_block) > 0):
            try:
                ...
                print "QTablePipe.cgf_create_hashvalue_table get error : " + str(e);
                self.cgv_meta_hooker.cgf_update_sharding_status(v_sharding_id = self.cgv_sharding_id,
                v_sharding_status = "error",v_error_info = "QTablePipe.cgf_create_hashvalue_table get error : " + str(e));
                self.cgv_meta_hooker.cgf_update_task_status(v_task_id = self.cgv_task_id,
                v_task_status = "error",v_error_info = "QTablePipe.cgf_create_hashvalue_table get error:" + str(e));
                os._exit(0);
        ...
        try:
            ...
            if (self.cgv_source_db.cgv_dbtype == "Oracle"):
                ...
                if (self.cgv_source_db.cgv_db_cur):
                    ...
                    self.cgv_meta_hooker.cgf_update_task_status(v_task_id = self.cgv_task_id,v_task_status = "finished");
            ...
            print "QTablePipe.cgf_data_transfor get error :" + str(e);
            #涉及对比库端事务的进行回滚
            self.cgv_crusher_db.cgv_conn_db.rollback();
            # 处理出错，更新sharding的状态为error
            self.cgv_meta_hooker.cgf_update_sharding_status(v_sharding_id = self.cgv_sharding_id,
                v_sharding_status = "error",v_error_info = "QTablePipe.cgf_data_transfor get error :" + str(e));
            self.cgv_meta_hooker.cgf_update_task_status(v_task_id = self.cgv_task_id,
                v_task_status = "error",v_error_info = "QTablePipe.cgf_data_transfor get error:" + str(e));
            os._exit(0);
...
class QTableCrusher():
    ...
    def cgv_dismiss_data_split(self):
        """划分dismatch和missing block"""
        self.cgv_missing_block[:] = [];
        self.cgv_dismatch_block[:] = [];
        for i in xrange(len(self.cgv_data_block)):
            if (self.cgv_data_block[i][5] is None or len(self.cgv_data_block[i][5]) < 1):
    ...
    def cgf_twinstab_crusher(self):
        ...
        try:
            ...
            self.cgv_meta_hooker.cgf_update_twins_status(v_twins_id = self.cgv_twins_id,v_twins_status = "checking");
            ...
            if (self.cgv_crusher_db.cgv_db_cur):
                ...
                if (self.cgv_literate_check == True):
                    ...
                    seq_dismiss_rows.nextval as id,%s as twins_id,'%s' as twins_name,
                    s.keystr,s.rowid as source_rowid,t.rowid as target_rowid,
                    s.TABSHARDING_ID as source_sharding_id,
                    t.TABSHARDING_ID as target_sharding_id,'new' as row_status
                    from %s s,%s t
                    where s.keystr = t.keystr(+)
                    and (s.datastr != t.datastr or t.keystr is null)""" % 
                    (self.cgv_process_parallel,self.cgv_process_parallel,self.cgv_twins_id,self.cgv_twins_name,
                        self.cgv_source_stname,self.cgv_target_stname);
                        ...
                        if (len(self.cgv_dismatch_block) > 0):
                            ...
                            if (self.cgv_dml_cur):
                                v_dismatch_sql = """insert into q_check_dismatch_rows
                                        ...
                                        source_sharding_id,target_sharding_id,row_status)
                                        values
                                        (:id,:twins_id,:twins_name,:keystr,:source_rowid,:target_rowid,
                                        :source_sharding_id,:target_sharding_id,:row_status)""";
                ...
                if (self.cgv_need_surplus == True):
                    ...
                    seq_surplus_rows.nextval as id,%s as twins_id,'%s' as twins_name,
                    s.keystr,s.rowid as source_rowid,t.rowid as target_rowid,
                    s.TABSHARDING_ID as source_sharding_id,
                    t.TABSHARDING_ID as target_sharding_id,'new' as row_status
                    from %s t,%s s
                    ...
                    and s.keystr is null""" % 
                    (self.cgv_process_parallel,self.cgv_process_parallel,self.cgv_twins_id,self.cgv_twins_name,
                        self.cgv_target_stname,self.cgv_source_stname);
                    ...
                    while (v_is_continue):
                        ...
                        if (len(self.cgv_surplus_block) > 0):
                            if (self.cgv_dml_cur):
                                ...
                                # 计数器累计
                                v_surplus_rows = v_surplus_rows + len(self.cgv_data_block);
                        else:
                            v_is_continue = False;

            # 更新twins信息，task信息，干活结束
            self.cgv_meta_hooker.cgf_update_twins_status(v_twins_id = self.cgv_twins_id,v_twins_status = "checked");
            ...
            self.cgv_meta_hooker.cgf_update_twins_missing(v_twins_id = self.cgv_twins_id,v_dismatch_rows = v_missing_rows);
            self.cgv_meta_hooker.cgf_update_twins_surplus(v_twins_id = self.cgv_twins_id,v_surplus_rows = v_surplus_rows);
        except Exception as e:
            print "QTableCrusher.cgf_twinstab_crusher get error :" + str(e);
            self.cgv_crusher_db.cgv_conn_db.rollback();
            self.cgv_meta_hooker.cgf_update_twins_status(v_twins_id = self.cgv_twins_id,v_twins_status = "error",
                v_error_info = "QTableCrusher.cgf_twinstab_crusher get error :" + str(e));
...
if __name__ == "__main__":
    ...
    v_crusher_db = QConnectDB(v_ip = "10.10.100.41",v_port = 1521,v_sid_or_dbname = "RACOne_1",
